...
public class Device {
  ...
  /**
   * The device SCTP capabilities, generated by combining both the underlying WebRTC capabilities and
   * the router SCTP capabilities (see {@link #load(String, PeerConnection.Options)} method).
   *
