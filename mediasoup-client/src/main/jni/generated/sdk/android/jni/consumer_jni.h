...
const char kClassPath_org_mediasoup_droid_Consumer[] =
...
inline jclass org_mediasoup_droid_Consumer_Listener_clazz(JNIEnv *env) {
    return base::android::LazyGetClass(env, kClassPath_org_mediasoup_droid_Consumer_Listener,
...
static std::atomic<jmethodID> g_org_mediasoup_droid_Consumer_Listener_onTransportClose(
        nullptr);
...
static void Java_Mediasoup_Consumer_Listener_onTransportClose(
    ...
    CHECK_CLAZZ(env, obj.obj(),
                org_mediasoup_droid_Consumer_Listener_clazz(env), 0);
