...
inline jclass org_mediasoup_droid_Transport_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env, kClassPath_org_mediasoup_droid_Transport, &g_org_mediasoup_droid_Transport_clazz);
}
...
inline jclass org_mediasoup_droid_Transport_Listener_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env,
	  kClassPath_org_mediasoup_droid_Transport_Listener,
  ...
  JNIEnv* env, const base::android::JavaRef<jobject>& obj)
{
	...
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_Transport_clazz(env), 0);

	jni_generator::JniJavaCallContextChecked call_context;
	call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
	  env, clazz, "getNativeTransport", "()J", &g_org_mediasoup_droid_Transport_getNativeTransport);
...
static void Java_Mediasoup_Listener_OnConnect(
  JNIEnv* env,
  ...
  const base::android::JavaRef<jstring>& dtlsParameters)
{
	...
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_Transport_Listener_clazz(env));
	...
	env->CallVoidMethod(obj.obj(), call_context.base.method_id, transport.obj(), dtlsParameters.obj());
}

static std::atomic<jmethodID> g_org_mediasoup_droid_Transport_Listener_onConnectionStateChange(nullptr);

static void Java_Mediasoup_Listener_OnConnectionStateChange(
  JNIEnv* env,
  const base::android::JavaRef<jobject>& obj,
  const base::android::JavaRef<jobject>& transport,
  const base::android::JavaRef<jstring>& connectionState)
{
	...
	env->CallVoidMethod(obj.obj(), call_context.base.method_id, transport.obj(), connectionState.obj());
}
