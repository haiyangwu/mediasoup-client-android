...
inline jclass org_mediasoup_droid_PeerConnection_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env, kClassPath_org_mediasoup_droid_PeerConnection, &g_org_mediasoup_droid_PeerConnection_clazz);
}
...
inline jclass org_mediasoup_droid_PeerConnection_Options_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env,
	  kClassPath_org_mediasoup_droid_PeerConnection_Options,
	  &g_org_mediasoup_droid_PeerConnection_Options_clazz);
}

#endif

static std::atomic<jmethodID> g_org_mediasoup_droid_PeerConnection_getNativeOwnedPeerConnection(nullptr);
  ...
  JNIEnv* env, const base::android::JavaRef<jobject>& obj)
{
	...
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_PeerConnection_clazz(env), 0);
...
static std::atomic<jmethodID> g_org_mediasoup_droid_PeerConnection_Options_getRTCConfig(nullptr);

static base::android::ScopedJavaLocalRef<jobject> Java_Mediasoup_PeerConnection_Options_getRTCConfig(
  JNIEnv* env, const base::android::JavaRef<jobject>& obj)
{
	jclass clazz = org_mediasoup_droid_PeerConnection_Options_clazz(env);
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_PeerConnection_Options_clazz(env), NULL);
	jni_generator::JniJavaCallContextChecked call_context;
	call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
	  env,
	  clazz,
...
static std::atomic<jmethodID> g_org_mediasoup_droid_PeerConnection_Options_getNativeFactory(nullptr);

static jlong Java_Mediasoup_PeerConnection_Options_getNativeFactory(
  JNIEnv* env, const base::android::JavaRef<jobject>& obj)
{
	jclass clazz = org_mediasoup_droid_PeerConnection_Options_clazz(env);
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_PeerConnection_Options_clazz(env), NULL);
