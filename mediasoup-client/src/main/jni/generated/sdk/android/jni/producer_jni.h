...
inline jclass org_mediasoup_droid_Producer_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env, kClassPath_org_mediasoup_droid_Producer, &g_org_mediasoup_droid_Producer_clazz);
}
...
inline jclass org_mediasoup_droid_Producer_Listener_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env,
	  kClassPath_org_mediasoup_droid_Producer_Listener,
  ...
  JNIEnv* env, jlong nativeProducer)
{
	...
	CHECK_CLAZZ(env, clazz, org_mediasoup_droid_Producer_clazz(env), NULL);

	jni_generator::JniJavaCallContextChecked call_context;
	call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
	  env, clazz, "<init>", "(J)V", &g_org_mediasoup_droid_Producer_Constructor);

	jobject ret = env->NewObject(clazz, call_context.base.method_id, nativeProducer);
	return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static std::atomic<jmethodID> g_org_mediasoup_droid_Producer_Listener_onTransportClose(nullptr);
  ...
  const base::android::JavaRef<jobject>& producer)
{
	...
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_Producer_Listener_clazz(env), 0);
