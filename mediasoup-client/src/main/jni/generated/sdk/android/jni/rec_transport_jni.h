...
inline jclass org_mediasoup_droid_RecvTransport_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env, kClassPath_org_mediasoup_droid_RecvTransport, &g_org_mediasoup_droid_RecvTransport_clazz);
}
...
inline jclass org_mediasoup_droid_RecvTransport_Listener_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env,
	  kClassPath_org_mediasoup_droid_RecvTransport_Listener,
  ...
  JNIEnv* env, jlong nativeRecvTransport)
{
	...
	CHECK_CLAZZ(env, clazz, org_mediasoup_droid_RecvTransport_clazz(env), NULL);

	jni_generator::JniJavaCallContextChecked call_context;
	call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
	  env, clazz, "<init>", "(J)V", &g_org_mediasoup_droid_RecvTransport_Constructor);

	jobject ret = env->NewObject(clazz, call_context.base.method_id, nativeRecvTransport);
