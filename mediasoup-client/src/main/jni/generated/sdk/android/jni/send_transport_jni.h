...
inline jclass org_mediasoup_droid_SendTransport_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env, kClassPath_org_mediasoup_droid_SendTransport, &g_org_mediasoup_droid_SendTransport_clazz);
}
...
inline jclass org_mediasoup_droid_SendTransport_Listener_clazz(JNIEnv* env)
{
	return base::android::LazyGetClass(
	  env,
	  kClassPath_org_mediasoup_droid_SendTransport_Listener,
  ...
  JNIEnv* env, jlong nativeSendTransport)
{
	...
	CHECK_CLAZZ(env, clazz, org_mediasoup_droid_SendTransport_clazz(env), NULL);

	jni_generator::JniJavaCallContextChecked call_context;
	call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
	  env, clazz, "<init>", "(J)V", &g_org_mediasoup_droid_SendTransport_Constructor);
...
static base::android::ScopedJavaLocalRef<jstring> Java_Mediasoup_Listener_OnProduce(
  JNIEnv* env,
  ...
  const base::android::JavaRef<jstring>& appData)
{
	...
	CHECK_CLAZZ(env, obj.obj(), org_mediasoup_droid_SendTransport_Listener_clazz(env));
